...
<html lang="fr">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark rounded">
          ...
          <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample10">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="../public/index.php?route=allArticle">Articles<span class="sr-only"></span></a>
              </li>
              <li class="nav-item">
    ...
    <div id="content">
        <div class="message">Message du system : <?php if (isset($_SESSION['message'])) {
          echo $_SESSION['message'];
        } else { ?>
        <em>Pas de message pour le moment...</em>
      </div>
      <?php } ?>
      <?= $content ?>
    </div>
    ...
    <footer>
      <div>    
        <p>Liens pour me suivre :<a href="https://www.linkedin.com/in/dimitri-subrini-b48848156/" class="fa fa-linkedin"></a><a href="https://www.facebook.com/profile.php?id=1152429246" class="fa fa-facebook"></a> </p>
      </div>
    </footer>
